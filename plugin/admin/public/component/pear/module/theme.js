layui.define(["jquery","layer"], function (exports) {
    ...
    theme.colorSet = function(color, second) {
        ...
        style += '.layui-laypage .layui-laypage-curr .layui-laypage-em{background-color:'+ second +'!important}'
        style += '.layui-laypage .layui-laypage-curr em{color: ' + color + '}'
        ...
        style += '.layui-laydate-header i:hover, .layui-laydate-header span:hover{color:'+ color +'}'
        style += '.layui-laydate-footer span:hover{color:'+ color +'}'
        style += '.layui-laypage a:hover{color:'+ color +'}'
        style += '.pear-tab .layui-tab-title .layui-this {background: '+ color +'!important}'
        style += '.pear-tab .layui-tab-title li:hover{background-color: '+ second +'}'
        if (color === '#2d8cf0') {
            style += '.layui-table-checked{background-color:#ecf5ff}'
            style += '.layui-table-checked.layui-table-click,.layui-table-checked.layui-table-hover{background-color:#d4e8ff}'
        }
